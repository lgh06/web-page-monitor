    ...
    <div className={highlight}>
      {
        ...
        <p>
          ...
          A tutorial located at <a target="_blank" rel="noopener noreferrer" href="https://docs.webpagemonitor.net/FAQ/How%20to%20find%20CSS%20selector/index.html" >here</a>.
        </p>
        ...
        <p>
          Please see our <a href={t(`https://docs.webpagemonitor.net/others/TOS/#TermsOfService`)} target="_blank" rel="noopener noreferrer">doc site</a>
        </p>
      ...
      }
      {
        ...
        <h2 id="TermsOfService"> {t('Terms of Service')} </h2>
        <p>
          请参阅 <a href={t(`https://docs.webpagemonitor.net/others/TOS/#TermsOfService`)} target="_blank" rel="noopener noreferrer">文档页面</a>
        </p>
