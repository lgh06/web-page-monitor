...
(function(c,l,a,r,i,t,y){
  ...
  y=l.getElementsByTagName(r)[0];y.parentNode.insertBefore(t,y);
      ...
      <Script defer id="switch_hint_js" src={'https://a-1251786267.file.myqcloud.com/webpagemonitor_doc_site/js/switch_hint.js?'+ Math.floor(Date.now() / 1000 / 3600 / 1.5)}></Script>
